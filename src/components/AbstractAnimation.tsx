...
const AbstractAnimation: React.FC = () => {
  ...
  const fragmentShader = `
    ...
    void main() {
      ...
      // Map the noise to a range between two white shades
      float whiteness = mix(0.6, 1.0, DF);  // 0.92 is slightly darker white, 1.0 is pure white
      vec3 color = vec3(whiteness);
